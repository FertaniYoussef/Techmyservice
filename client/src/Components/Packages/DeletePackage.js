...
const DeletePackage = ({
	...
	const deletePackage = async (e) => {
		...
		api
			.delete(`api/deletepackage?name=${Pack.name}`, header)
			.then((response) => {
        ...
        >
            ...
            <div ref={modalContent2} className="bg-white overflow-auto max-w-xl w-full max-h-full justify-center rounded-xl shadow-md overflow-hidden mx-auto my-auto">
                ...
                <div class="relative  w-full  items-center  ">
                        ...
                        <h1 class="font-bold text-base text-slate-900 mt-5 text-center mb-1">Do you really want to delete this package ?</h1>
