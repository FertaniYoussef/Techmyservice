...
function DashboardCard13() {
  return (
    <div className="col-span-full xl:col-span-6 bg-sky-50  rounded-sm border border-slate-200">
      <header className="px-3 py-3 border-b border-slate-100">
        <h2 className="font-semibold text-lg text-slate-800">Income/Expenses</h2>
      </header>
      <div className="p-3">
        ...
        {/* "Today" group */}
        <div>
          <header className="text-xs uppercase text-slate-50 bg-[#4a85e4] rounded-sm font-semibold p-2">Today</header>
          <ul className="my-1">
            {/* Item */}
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-slate-800 hover:text-slate-900 no-underline	">Qonto</a> billing</div>
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-slate-800 hover:text-slate-900 no-underline" href="#0">Cruip.com</a> Market Ltd 70 Wilson St London</div>
                  <div className="shrink-0 self-start ml-2">
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-slate-800 hover:text-slate-900 no-underline" href="#0">Notion Labs Inc</a></div>
                  <div className="shrink-0 self-start ml-2">
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-slate-800 hover:text-slate-900 no-underline" href="#0">Market Cap Ltd</a></div>
                  <div className="shrink-0 self-start ml-2">
            ...
            <li className="flex px-2">
              ...
              <div className="grow flex items-center border-b border-slate-100 text-sm py-2">
                <div className="grow flex justify-between">
                  <div className="self-center"><a className="font-medium text-slate-800 hover:text-slate-900 no-underline" href="#0">App.com</a> Market Ltd 70 Wilson St London</div>
                  <div className="shrink-0 self-start ml-2">
